...
RSpec.describe RecipesController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all recipes as @recipes" do
      ...
      expect(controller.recipes).to eq([recipe])
    end
  end
  ...
  describe "GET #show" do
    it "assigns the requested recipe as @recipe" do
      ...
      expect(controller.recipe).to eq(recipe)
    end
  end
  ...
  describe "GET #new" do
    it "assigns a new recipe as @recipe" do
      ...
      expect(controller.recipe).to be_a_new(Recipe)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created recipe as @recipe" do
        post :create, {:recipe => valid_attributes}, valid_session
        expect(controller.recipe).to be_a(Recipe)
        expect(controller.recipe).to be_persisted
      end
  ...
  describe "PUT #update" do
    ...
    context "with invalid params" do
      it "assigns the recipe as @recipe" do
        ...
        expect(controller.recipe).to eq(controller.recipe)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested recipe" do
      recipe = Recipe.create!(name: "My_rec", category: "My_cat", user_id: user.id)
      expect {
